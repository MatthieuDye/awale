  ...
  int recolte_joueur(int joueur[], int ordi[], int n, int *grenier_joueur, int case_finale_joueur)
  {
    ...
    } else
    {
      ...
      if( (ordi[case_finale_joueur-1]==2) || (ordi[case_finale_joueur-1]==3) )
      {
        ...
        while( ( case_finale_joueur <= n ) && ( (ordi[case_finale_joueur-1]==2) || (ordi[case_finale_joueur-1]==3) ) )
        {
  ...
  int recolte_ordi(int joueur[], int ordi[], int n, int *grenier_ordi, int case_finale_ordi)
  {
    ...
    } else
    {
      ...
      { 
        printf("Vous pouvez recolter \n");
        while( ( case_finale_ordi > 0 ) && ( (joueur[case_finale_ordi-1]==2) || (ordi[case_finale_ordi-1]==3) ) )
        {
     ...
     //Le tour commence
        ...
        if (fj<0)
        {
          ...
          if (fj == -1)
          {
            ...
            {
              printf("Tu as gagne !!! Felicitation ! =D \n");
            } else
            {
              if(grenier_joueur<grenier_ordi)
              {
                printf("Tu as perdu !!! LOOSER !! \n"); 
              } else
              {
          ...
          else 
          {
            if(fj == -2)
            {
              printf ("Le grenier de l'ordinateur a atteint 25 ! Il a gagné :) \n");
            }
            else 
            {
              if (fj == -3)
              ...
              else 
              {
                if (fj==-4)
                {
                  printf ("Il y a moins de 6 graines sur le plateau !\n");
                  if(grenier_joueur>grenier_ordi)
                  {
                    printf("Tu as gagne !!! Felicitation ! =D \n");
                  } else
